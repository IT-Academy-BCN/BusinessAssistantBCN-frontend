...
@Component({
    selector: 'virtual-assistant-component-showcase',
    template: `  
    <!-- MAT-TAB-GROUP -->
    <mat-tab-group color="accent" selectedIndex="0">

        <!-- selectedIndex="0" -->
        <mat-tab label="VA (Virtual Assistant) SHOWCASE">
...
export class VirtualAssistantShowcaseComponent implements OnInit, OnDestroy {
